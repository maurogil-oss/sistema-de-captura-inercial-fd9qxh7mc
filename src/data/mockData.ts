...
export const mockRecentEvents = [
  ...
  },
  {
    id: '3',
    type: 'CORNERING',
    driver: 'Motorista #084',
    time: '10:15 AM',
    baseSeverity: 5,
    weather: 'CLEAR' as WeatherCondition,
    location: 'Rodovia Castello Branco',
  },
  {
    id: '4',
    type: 'IDLING',
    driver: 'Motorista #221',
    time: '09:50 AM',
    baseSeverity: 2,
...
export const mockTripTimeline = Array.from({ length: 60 }).map((_, i) => ({
  ...
  jerk: Math.random() * 5 + (i === 20 ? 15 : 0) + (i === 45 ? 12 : 0),
  gForceZ: 1 + (Math.random() * 0.2 - 0.1) + (i === 35 ? 2.5 : 0),
  lateralForce: Math.sin(i / 5) * 0.8 + Math.random() * 0.1,
}))

export const mockESGData = [
  { month: 'Jan', co2: 5.2, idling: 120 },
  { month: 'Fev', co2: 4.8, idling: 110 },
  { month: 'Mar', co2: 4.5, idling: 95 },
  { month: 'Abr', co2: 4.2, idling: 80 },
  { month: 'Mai', co2: 3.9, idling: 75 },
